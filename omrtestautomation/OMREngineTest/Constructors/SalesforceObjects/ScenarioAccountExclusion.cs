...
{
    public class ScenarioAccountExclusion
    {
        [JsonIgnore]
        public string Id;
        ...
        {
            return string.Format("{0}ing Account {1} Exclusion to Territory {2}", Action__c, AccountUniqueIntegrationId__c, TerritoryUniqueIntegrationId__c);
        }
    };
}
