...
{
    public class ScenarioProductAccTerrExclusion
    {
        [JsonIgnore]
        public string Id;
        ...
        public string SOMProductAccTerrExclusionId__c;
        ...
        {
            return string.Format("{0}ing Product {1} Account {2} Exclusion to Territory {3}", Action__c, ProductUniqueIntegrationId__c, AccountUniqueIntegrationId__c, TerritoryUniqueIntegrationId__c);
        }
    }
}
