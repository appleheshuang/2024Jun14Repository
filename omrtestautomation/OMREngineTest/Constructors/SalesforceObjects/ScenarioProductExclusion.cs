...
{
    public class ScenarioProductExclusion
    {
        [JsonIgnore]
        public string Id;
        ...
        public string SOMProductExclusionId__c;
        ...
        {
            return string.Format("{0}ing Product {1} Exclusion to Territory {2}", Action__c, ProductUniqueIntegrationId__c, TerritoryUniqueIntegrationId__c);
        }
    }
}
