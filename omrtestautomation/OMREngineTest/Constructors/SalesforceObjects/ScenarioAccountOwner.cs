...
{
    public class ScenarioAccountOwner
    {
        [JsonIgnore]
        public string Id;
        ...
        public string SOMAccountOwnerId__c;
        ...
        {
            return string.Format("{0}ing Account {1} Ownership on Territory {2}", Action__c, AccountUniqueIntegrationId__c, TerritoryUniqueIntegrationId__c);
        }
    };
}
